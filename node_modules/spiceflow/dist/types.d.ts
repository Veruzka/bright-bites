...
import { SPICEFLOW_RESPONSE, InternalServerError, ParseError, ValidationError } from './error.js';
...
export type InlineHandler<Route extends RouteSchema = {}, Singleton extends SingletonBase = {
    state: {};
}, Path extends string = '', MacroContext = {}> = (context: MacroContext extends Record<string | number | symbol, unknown> ? Prettify<MacroContext & Context<Route, Singleton, Path>> : Context<Route, Singleton, Path>) => Response | MaybePromiseIterable<{} extends Route['response'] ? unknown : (Route['response'] extends {
    200: any;
