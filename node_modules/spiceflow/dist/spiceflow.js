...
const ajv = (addFormats.default || addFormats)(new (Ajv.default || Ajv)({ useDefaults: true }), [
    'date-time',
    'time',
    'date',
    'email',
...
export class Spiceflow {
    ...
    async listenNode(port, hostname = '0.0.0.0') {
        ...
        const server = createServer(async (req, res) => {
            ...
            const url = new URL(req.url || '', `http://${req.headers.host || hostname || 'localhost'}`);
