...
exports.babelPluginDeduplicateImports = babelPluginDeduplicateImports;
exports.babelPluginRenameExports = babelPluginRenameExports;
exports.babelPluginJsxTransform = babelPluginJsxTransform;
const BabelTypes = __importStar(require("@babel/types"));
const renamer_1 = __importDefault(require("./renamer"));
function babelPluginDeduplicateImports({ types: t, }) {
        ...
        visitor: {
            ...
            Program: {
                exit(path) {
                    ...
                    const renamer = new renamer_1.default(path.scope, map);
                    renamer.rename();
...
function babelPluginRenameExports({ map, }) {
    return {
        name: 'rename-exports',
        visitor: {
...
function babelPluginJsxTransform() {
    return {
        name: 'jsx-transform',
        visitor: {
            CallExpression(path) {
                            ...
                            if (prop.value.type === 'ArrayExpression') {
                                jsxElement.children = prop.value.elements.map((element) => {
                                    if (noContainerTypes.has(element.type) ||
                                        (element.type ===
                                            'CallExpression' &&
                                            element.callee?.name?.startsWith('_jsx'))) {
                                        return element;
                                    }
                                    return {
                                ...
                                if (noContainerTypes.has(prop.value.type) ||
                                    (prop.value.type === 'CallExpression' &&
                                        prop.value.callee?.name?.startsWith('_jsx'))) {
