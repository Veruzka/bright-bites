...
function esbuildPluginBundleDependencies({ signal = undefined, externalPackages = [], externalizeNpm = false, outDir, onMissingPackage = (pkg) => { }, }) {
    ...
    const spinner = (0, nanospinner_1.createSpinner)('Fetching Framer Components Modules');
    spinner.start();
    const plugin = {
        name: 'esbuild-plugin',
        setup(build) {
            ...
            build.onLoad({ filter: /.*/, namespace }, async (args) => {
                ...
                const promise = Promise.resolve().then(async () => {
                    ...
                    const res = await (0, exports.fetchWithRetry)(resolved, { signal });
                    if (!res.ok) {
...
exports.fetchWithRetry = retryTwice(node_fetch_commonjs_1.default);
