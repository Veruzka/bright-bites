...
function AdaptedLink({ href, nodeId, openInNewTab, smoothScroll, children, ...rest }) {
    ...
    return (0, jsx_runtime_1.jsx)(framer_js_2.FramerLink, { href: path, ...rest, ...onlyForFramer });
}
function ContextProviders({ locale, children, framerSiteId, routes, 
// collectionUtils,
locales, }) {
    ...
    return ((0, jsx_runtime_1.jsx)(framer_js_2.FetchClientProvider, { children: (0, jsx_runtime_1.jsx)(framer_js_2.CustomCursorHost, { children: (0, jsx_runtime_1.jsx)(framer_js_2.FormContext.Provider, { value: framerSiteId, children: (0, jsx_runtime_1.jsx)(framer_js_2.LocaleInfoContext, { value: localeInfo, children: (0, jsx_runtime_1.jsx)(routesContext.Provider, { value: routes, children: children }) }) }) }) }));
}
