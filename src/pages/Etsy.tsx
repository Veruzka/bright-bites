...
import ImgHero from '../stories/assets/ceramics3D_etsyHero.png';
    ...
    return (
        <div style={{ display: "flex", height: "100vh", width: "100vw", overflow: "hidden" }}>
            ...
            <div style={{ flexGrow: 1, display: "flex", flexDirection: "column", width: "100%", overflow: "auto" }}>
                ...
                <InfoBar
                    items={[
                    { icon: Money, text: "Weekly sales: $712.00" },
                    { icon: ClockClockwise, text: "Last updated: Aug 1, 2022" },
                    ]}
                />
                <div style={{ flexGrow: 1, padding: "24px 80px" }}>
                    <Spacing size={"32"}/>
                    <div className="card-header">
                    <div className="page-avatar" style={{ backgroundImage: `url(${etsyLogo})` }}/>
                    <p className="small caption">in Etsy</p>
                    </div>
                    <Spacing size={"32"}/>
